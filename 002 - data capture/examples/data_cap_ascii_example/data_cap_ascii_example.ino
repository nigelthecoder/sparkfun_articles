/*
 * Data capture using ASCII CSV text over the serial port.
 * 
...
void loop() 
{
  ...
  char buf[128]; // make sure it's long enough
  sprintf(buf, "%ld,%d,%d", now, v1, v2);

  // send it over the serial link with a newline character at the end
  Serial.println(buf);
